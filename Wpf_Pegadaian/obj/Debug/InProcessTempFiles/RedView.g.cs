...
namespace Wpf_Pegadaian.Forms {
    ...
    public partial class RedView : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(RedView).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(RedView));
        ...
        private string FindResource() {
            string[] resources = typeof(RedView).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".RedView.g.xaml") || resource.Equals("RedView.g.xaml"))) {
                    return resource;
                }
            }
